...
import com.taka4602.line_chrome.line.TType
import com.taka4602.line_chrome.line.TVal
import com.taka4602.line_chrome.line.fields
import com.taka4602.line_chrome.line.packBinary
import com.taka4602.line_chrome.line.packCompact
import com.taka4602.line_chrome.line.tGet
import com.taka4602.line_chrome.line.tInt
import com.taka4602.line_chrome.line.tStr
import com.taka4602.line_chrome.line.unpackCompactStruct
...
class ThriftTest {
    ...
    fun `binary that is not valid UTF-8 decodes to bytes`() {
        ...
        val full = packCompact("x", listOf(
            com.taka4602.line_chrome.line.TField(1, TVal.Bin(raw))
        ))
        val struct = unpackCompactStruct(full.copyOfRange(5, full.size))
