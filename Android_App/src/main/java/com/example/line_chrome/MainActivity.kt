...
import com.example.line_chrome.ui.AppRoot
import com.example.line_chrome.ui.theme.LineChromeTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            // A demo has no socket to hold open, and a permanent "Connecting…"
            // notification over a session that does not exist would be a lie.
            if (LineRepository.DEMO) return@launch
